...
},{"./cjs/react-dom.production.min.js":"jF7N"}],"hRTX":[function(require,module,exports) {
'use strict';
...
},{"./../utils":"Feqj","./../core/settle":"Ztkp","./../helpers/cookies":"MLCl","./../helpers/buildURL":"phSU","../core/buildFullPath":"dm4E","./../helpers/parseHeaders":"Zn5P","./../helpers/isURLSameOrigin":"Rpqp","../core/createError":"NZT3"}],"HuC1":[function(require,module,exports) {
...
},{"./utils":"Feqj","./helpers/normalizeHeaderName":"njyv","./core/enhanceError":"Lpyz","./adapters/xhr":"akUF","./adapters/http":"akUF","process":"HuC1"}],"IAOH":[function(require,module,exports) {
'use strict';
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\w\\refinitiv_test\\sect2\\q2",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/axios":"Wzmt"}],"QaRv":[function(require,module,exports) {
module.exports = "tail-spin.671bc6c0.svg";
...
var tail_spin_svg_1 = __importDefault(require("./img/tail-spin.svg"));
...
var App = function App(_) {
  ...
  function query() {
    ...
    debounceHandler = window.setTimeout(function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , axios_1.default.get("https://api.publicapis.org/categories")];
  ...
  var filterResults = results.filter(function (r) {
  ...
  function renderResult() {
    ...
    return /*#__PURE__*/React.createElement("div", null, filterResults.map(function (row) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: "container"
  }, /*#__PURE__*/React.createElement("h1", null, "Category filter"), /*#__PURE__*/React.createElement("input", {
    id: "search",
    type: "text",
    value: searchString,
...
exports.App = App;
},{"axios":"O4Aa","react":"HdMw","./img/tail-spin.svg":"QaRv"}],"zo2T":[function(require,module,exports) {
"use strict";
...
react_dom_1.default.render( /*#__PURE__*/React.createElement(app_1.App, null), rootEle);
},{"react":"HdMw","react-dom":"X9zx","./app":"owv9"}]},{},["zo2T"], null)
//# sourceMappingURL=q2_src.cd12b7f4.js.map